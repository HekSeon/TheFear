...
//static CAMERA* g_Camera =GetCamera();
//
//static XMFLOAT3 Pos= g_Cube[SetCudeNumder()].pos;
//static XMFLOAT3 Rot=g_Cube[SetCudeNumder()].rot;
//static XMFLOAT3 Scl= g_Cube[SetCudeNumder()].scl;
//XMVECTOR oRot = XMLoadFloat3(&Pos);
//XMVECTOR oScl = XMLoadFloat3(&Rot);
//XMVECTOR oPos = XMLoadFloat3(&Scl);
//
//static int e = 0;
//static int asa = 0;
//static int sa = 0;
//
//static int Enemy = 0;
//static float PlayerPosMagnification = 0.0f;//プレイヤーのポジションの倍率
//static float cameraPosMagnification = 0.0f;//プレイヤーのポジションの倍率
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("The Fear", p_open, window_flags))
    {
        ImGui::End();
        return;
    }
    ...
    ImGui::Text(u8"d imgui says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Window options"))
    {
        ...
        {
            //ImGui::TableNextColumn(); ImGui::Checkbox("Create", (bool*)&g_Player->Create);
